 ...
 */
final class Version20190726055620 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE belong_to_temporary (user_id INT NOT NULL, organization_id INT NOT NULL, INDEX IDX_201951EEA76ED395 (user_id), INDEX IDX_201951EE32C8A3DE (organization_id), PRIMARY KEY(user_id, organization_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE belong_to (organization_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C86E276D32C8A3DE (organization_id), INDEX IDX_C86E276DA76ED395 (user_id), PRIMARY KEY(user_id, organization_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
